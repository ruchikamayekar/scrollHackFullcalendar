...
var Scroller = /** @class */ (function (_super) {
    ...
    Scroller.prototype.lockOverflow = function (scrollbarWidths) {
        ...
        if (overflowY === 'auto') {
            console.log(this.scrollEl[0].scrollHeight +"======= "+ this.scrollEl[0].clientHeight);
            overflowY = (scrollbarWidths.left || scrollbarWidths.right || // vertical scrollbars?
                // OR scrolling pane with massless scrollbars?
                this.scrollEl[0].scrollHeight - 1 > this.scrollEl[0].clientHeight) ? 'scroll' : 'hidden';
            var mainDivheight = this.scrollEl[0].clientHeight;
                setTimeout(function(){
                if($(".fc-content-skeleton table tbody").height() > mainDivheight){
                    console.log("inside");
                    $(".fc-scroller.fc-day-grid-container").css("overflow-y","scroll");
                }

                //console.log("after"+this.scrollEl[0].scrollHeight +"======= "+ this.scrollEl[0].clientHeight);
